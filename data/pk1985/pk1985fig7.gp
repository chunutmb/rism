...
set format x ""
set ytics ("0.0" 0.0, "0.6" 0.6)

plot [:][:] \
  "modelIIIc_out.dat" u 1:(($7 == 3 && $8 == 3)?$6-$9:1/0)  w l ls 2 t "+ +, {/Times-Italic U}^*   ", \
  "modelIIIc_out.dat" u 1:(($7 == 3 && $8 == 3)?$6-$3:1/0)  w l ls 1 t "+ +, PMF", \
...
plot [:][:] \
  "modelIIIc_out.dat" u 1:(($7 == 4 && $8 == 4)?$6-$9:1/0)  w l ls 2 t "- -, {/Times-Italic U}^*   ", \
  "modelIIIc_out.dat" u 1:(($7 == 4 && $8 == 4)?$6-$3:1/0)  w l ls 1 t "- -, PMF", \
...
set ytics ("-0.6" -0.6, "0.0" 0.0, "0.6" 0.6)
set ylabel "{/Times-Italic E} / {/Times-Italic kT}" offset 1, 10

plot [:][:] \
  "modelIIIc_out.dat" u 1:(($7 == 3 && $8 == 4)?$6-$9:1/0)  w l ls 2 t "+ -, {/Times-Italic U}^*   ", \
  "modelIIIc_out.dat" u 1:(($7 == 3 && $8 == 4)?$6-$3:1/0)  w l ls 1 t "+ -, PMF", \
